const CACHE_NAME = "dxiangqi-shell-v225";
const STATIC_ASSETS = [
  "/",
  "/index.html",
  "/analysis.html",
  "/portal.css?v=20260730-account-auth-v1",
  "/puzzle-data.js?v=20260727-puzzle-v1",
  "/endgame-data.js?v=20260728-endgame-v3",
  "/portal.js?v=20260730-account-auth-v1",
  "/styles.css?v=20260730-account-auth-v1",
  "/app.js?v=20260730-account-auth-v1",
  "/config.js",
  "/xiangqi-core.js",
