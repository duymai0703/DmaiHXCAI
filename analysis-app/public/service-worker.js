const CACHE_NAME = "ymegalodon-shell-v170";
const STATIC_ASSETS = [
  "/",
  "/index.html",
  "/analysis.html",
  "/portal.css?v=20260727-hover-fix-v1",
  "/portal.js?v=20260727-hover-fix-v1",
  ...
  "/assets/icons/sharklight.png?v=20260727-hover-fix-v1",
